...
public class LDE {
	...
	public void insert(int x) {
		if (isEmpty()) {
			...
			Node newNode = new Node(x);				  	//Instanciação de um novo Nó 'aux' que receberá o valor digitado pelo usuário
			Node aux2 = firstNode;				   //Outro Nó 'aux2' aponta pro primeiro Nó da lista
				while (newNode.value >= aux2.value) { //Ciclo pra percorrer a lista até que satisfaça a condição
					aux2 = aux2.next;				
				}
			newNode.next = aux2;				
